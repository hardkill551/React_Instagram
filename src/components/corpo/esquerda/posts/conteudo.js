  ...
  const x = 101
    return (
      ...
      <img data-test="post-image" onDoubleClick={() => setCurtidas(adicionarCurtida(curtidas, x))} src={props.imagePost} alt={props.nomeImagem}/>
        ...
        <div className="acoes">
          <div>
            <ion-icon data-test="like-post" onClick={() => setCurtidas(adicionarCurtidas(curtidas, x))} name="heart-outline"></ion-icon>
            <ion-icon name="chatbubble-outline"></ion-icon>
            <ion-icon name="paper-plane-outline"></ion-icon>
          </div>
          <div>
            <ion-icon data-test="likes-number" name="bookmark-outline"></ion-icon>
          </div>
        </div>
